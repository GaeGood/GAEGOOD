...
viewsRouter.use("/products/:pid/detail", serveStatic("product-detail"));
...
viewsRouter.use("/categories/:cid/detail", serveStatic("category-detail"));
...
viewsRouter.use("/orders/:oid/detail", serveStatic("order-detail"));
